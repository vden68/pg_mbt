...
@pytest.allure.step('test_table_fn_pg_pathman_range_id_multi_insert_commit_or_rollback')
def test_table_fn_pg_pathman_range_id_multi_insert_commit_or_rollback(db, generator):
