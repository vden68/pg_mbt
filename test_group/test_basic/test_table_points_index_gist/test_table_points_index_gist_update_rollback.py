...
@pytest.allure.step('test_table_points_index_gist_update_rollback')
def test_table_points_index_gist_update_rollback(db, generator):
    print("\n\ntest_table_points_index_gist_update_rollback \n\n")
