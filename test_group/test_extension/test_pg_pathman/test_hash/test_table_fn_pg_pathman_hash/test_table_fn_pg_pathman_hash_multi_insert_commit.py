...
@pytest.allure.step('test_table_fn_pg_pathman_hash_multi_insert_commit')
def test_table_fn_pg_pathman_hash_multi_insert_commit(db, generator):
    print("\n\ntest_table_fn_pg_pathman_hash_multi_insert_commit \n\n")
